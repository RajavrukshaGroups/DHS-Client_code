        ...
        <div className="top-inner clearfix">
          <div className="left-column pull-left">
            <ul className="info clearfix">
              <li>
                <FontAwesomeIcon icon={faMapMarkerAlt} /> Bangalore, Karnataka,
                India
              </li>
              <li>
                <FontAwesomeIcon icon={faClock} /> Wed - Mon | 9.30AM - 6.30PM
              </li>
              <li>
                <FontAwesomeIcon icon={faPhone} /> 080 - 29903931
              </li>
            </ul>
          </div>
          <div className="right-column pull-rights-login">
            <div className="sign-box1">
              <a href="/memberlogin">
                <FontAwesomeIcon icon={faUser} /> {memberData.email}
              </a>
            </div>
            <div className="sign-box2" style={{ paddingLeft: "15px" }}>
              <a onClick={handleLogout}>
                <FontAwesomeIcon icon={faDesktop} /> Logout
              </a>
            </div>
          </div>
        </div>
