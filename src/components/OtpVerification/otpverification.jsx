...
const handleResend = async () => {
  ...
  try {
    ...
    // });
      const res= await axios.post("https://memberpanel.defencehousingsociety.com/defenceWebsiteRoutes/resend-otp", {
                email: formData.email,
              });
    if (res.data.success) {
 ...
 const handleChange = (value, index) => {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      // ✅ Verify OTP first
      const verifyRes = await axios.post("https://memberpanel.defencehousingsociety.com/defenceWebsiteRoutes/verify-otp", {
        email: formData.email,
        otp: finalOtp,
      });
      ...
      await axios.post("https://memberpanel.defencehousingsociety.com/defenceWebsiteRoutes/add-onlinemember", submissionData, {
